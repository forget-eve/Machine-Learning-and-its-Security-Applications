...
<p align="center">
  <img src="./img/空间上下文匹配步骤1.jpg" alt="空间上下文匹配步骤">
</p>
...
<p align="center">
  <img src="./img/图像到文本的注意力计算流程2.jpg" alt="图像到文本的注意力计算流程">
</p>
...
- [x] 人脸伪造又称为人脸图像生成，一直是图像生成领域的热点，基于深度学习的生成对抗网络(GAN)和自编码器(AutoEncoder)模型使得现有生成技术能够生成极为逼真、肉眼难以鉴别的人脸图像，例如，StyleGAN和ProGAN等生成对抗网络模型，可以根据输入的随机向量直接生成一幅高质量人脸图像。
